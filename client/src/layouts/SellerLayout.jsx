...
export default function SellerLayout() {
  ...
  const navItems = [
    ...
    { label: 'Add Product', path: '/seller/products/new', icon: 'add_box' },
    { label: 'Orders', path: '/seller/orders', icon: 'shopping_bag' },
    { label: 'Store Profile', path: '/seller/profile', icon: 'store' },
  ];
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop h-20 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <Link to="/seller/dashboard" className="flex items-center gap-2">
              ...
              <span className="bg-secondary-container text-on-secondary-container font-label-sm text-xs px-2.5 py-0.5 rounded-full uppercase tracking-wider font-semibold">
                Seller Hub
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden lg:block text-left">
                <p className="font-label-md text-sm text-on-surface font-medium leading-none">{user?.name || 'Seller'}</p>
            ...
            <div className="w-4/5 max-w-xs bg-surface h-full p-6 flex flex-col justify-between shadow-xl">
              <div>
                <div className="flex justify-between items-center mb-8 border-b border-surface-variant pb-4">
                  <span className="font-display-lg text-headline-md text-primary">Seller Portal</span>
